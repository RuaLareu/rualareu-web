# Prompt: Revertir AboutSection al original (sin foto)

Modificar `src/components/sections/AboutSection.tsx`. Reemplazar el archivo completo por esto:
...
git commit -m "fix: revertir AboutSection al original sin foto"
