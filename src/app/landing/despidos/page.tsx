...
const WHATSAPP_URL =
  "https://wa.me/5492236972421?text=Hola%2C%20me%20despidieron%20y%20quisiera%20asesorarme.";
...
const jsonLd = {
  ...
  "@type": "LegalService",
  name: "RUA | LAREU - Abogados por Despido",
  description:
    "Abogados laboralistas en Mar del Plata. Reclamos por despido sin causa, despido indirecto, trabajo no registrado y liquidación final.",
  url: "https://rualareu.com/landing/despidos",
...
export default function DespidosLanding() {
  return (
    <>
      <script
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center bg-primary overflow-hidden">
          <Image
            src="https://images.unsplash.com/photo-1521790797524-b2497295b8a0?w=1920&q=80&auto=format&fit=crop"
            alt=""
            fill
            priority
          ...
          <div className="relative z-20 w-full max-w-3xl mx-auto px-6 py-32 text-center">
            ...
            <p className="text-white/60 text-lg sm:text-xl leading-relaxed max-w-xl mx-auto mb-4">
              Podés reclamar lo que te corresponde.
            </p>
            <p className="text-white/85 text-sm sm:text-base mb-10">
              Abogados laboralistas en Mar del Plata. Calculamos tu indemnización y peleamos para que cobres lo justo.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 text-balance md:min-h-[4rem] flex items-end justify-center">Si te obligaron a renunciar</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-text-secondary text-sm text-center max-w-xl mx-auto mb-10">
              Atendemos todo tipo de reclamos laborales del trabajador. Si tu caso no aparece en la lista,
              consultanos igual.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                "Despido sin causa",
                "Despido con causa injustificada",
                "Despido indirecto",
