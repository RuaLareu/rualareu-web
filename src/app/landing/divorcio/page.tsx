...
import { Phone, MessageCircle, Star, Heart, Users, Home, ChevronDown } from "lucide-react";
...
const WHATSAPP_URL =
  "https://wa.me/5492236972421?text=Hola%2C%20quisiera%20asesorarme%20sobre%20un%20divorcio.";
...
const jsonLd = {
  ...
  "@type": "LegalService",
  name: "RUA | LAREU - Abogados de Familia y Divorcios",
  description:
    "Abogados de familia y divorcios en Mar del Plata. Divorcio express, cuota alimentaria, cuidado personal, régimen de comunicación y división de bienes.",
  url: "https://rualareu.com/landing/divorcio",
...
export default function DivorcioLanding() {
  return (
    <>
      <script
        ...
        <section className="relative min-h-screen flex items-center bg-primary overflow-hidden">
          ...
          <div className="relative z-20 w-full max-w-3xl mx-auto px-6 py-32 text-center">
            ...
            <h1 className="text-white text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-6">
              Divorciarte no tiene
              <br />
              por qué ser una batalla.
            </h1>
            <p className="text-white/60 text-lg sm:text-xl leading-relaxed max-w-xl mx-auto mb-4">
              Divorcio express: rápido, simple y sin conflicto.
            </p>
            <p className="text-white/85 text-sm sm:text-base mb-10">
              Abogados de familia en Mar del Plata. Gestionamos tu divorcio y todos los acuerdos: hijos, alimentos y bienes.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Divorcio de común acuerdo</h3>
              ...
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Divorcio unilateral</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
                  No necesitás el consentimiento de tu cónyuge para divorciarte. Iniciamos el trámite igual y
                  gestionamos todos los efectos: alimentos, cuidado de los hijos y división de bienes.
                </p>
              </div>
              <div className="text-center flex flex-col h-full">
                <div className="w-14 h-14 bg-primary-light text-primary flex items-center justify-center mx-auto mb-5 rounded-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Acuerdos y efectos del divorcio</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-text-secondary text-sm text-center max-w-xl mx-auto mb-10">
              Cubrimos todo el ámbito del derecho de familia. Si tu situación no aparece en la lista,
              consultanos igual.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-2xl mx-auto px-6">
            ...
            <FAQItem
              ...
              answer="Depende del juzgado y de si hay acuerdo. Un divorcio de común acuerdo con propuesta bien armada suele resolverse en pocos meses. Sin acuerdo, el divorcio igual se dicta; los efectos (bienes, alimentos) se discuten aparte."
            />
            <FAQItem
              question="¿Necesito que mi cónyuge esté de acuerdo?"
              answer="No. Desde 2015 el divorcio es incausado: cualquiera de los dos puede pedirlo sin expresar motivos y sin el consentimiento del otro."
            />
            <FAQItem
              question="¿Qué pasa con los hijos y los bienes?"
              answer="Se resuelven mediante acuerdos (plan de parentalidad, alimentos, división de bienes) que el juez homologa. Si no hay acuerdo, cada punto se tramita por separado. Te asesoramos para proteger tus derechos."
            />
            <FAQItem
