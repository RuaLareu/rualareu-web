          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                {
                  step: "3", icon: Layers,
                  title: "Publicación en el Boletín",
                ...
                <div key={item.step} className="text-center flex flex-col items-center h-full">
                  ...
                  <h3 className="font-semibold text-primary text-base mb-2 text-balance md:min-h-[3.5rem] flex items-end justify-center">{item.title}</h3>
