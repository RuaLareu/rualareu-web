...
import { Phone, MessageCircle, Star, ScrollText, Home, Users, ChevronDown } from "lucide-react";
...
const WHATSAPP_URL =
  "https://wa.me/5492236972421?text=Hola%2C%20necesito%20asesoramiento%20para%20iniciar%20una%20sucesi%C3%B3n.";
...
const jsonLd = {
  ...
  "@type": "LegalService",
  name: "RUA | LAREU - Abogados de Sucesiones",
  description:
    "Abogados de sucesiones en Mar del Plata. Trámite sucesorio, declaratoria de herederos, inscripción de bienes y resolución de conflictos entre herederos.",
  url: "https://rualareu.com/landing/sucesiones",
...
export default function SucesionesLanding() {
  return (
    <>
      <script
        ...
        <section className="relative min-h-screen flex items-center bg-primary overflow-hidden">
          ...
          <div className="relative z-20 w-full max-w-3xl mx-auto px-6 py-32 text-center">
            ...
            <p className="text-white/85 text-sm sm:text-base mb-10">
              Abogados de familia en Mar del Plata. Llevamos adelante todo el trámite hasta la inscripción de los bienes a nombre de los herederos.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 text-balance md:min-h-[4rem] flex items-end justify-center">Si perdiste un familiar</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
                  Iniciamos la sucesión, gestionamos las publicaciones y los edictos, y llevamos el
                  expediente hasta la declaratoria de herederos y la inscripción de los bienes.
                </p>
              </div>
              <div className="text-center flex flex-col h-full">
                <div className="w-14 h-14 bg-primary-light text-primary flex items-center justify-center mx-auto mb-5 rounded-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 text-balance md:min-h-[4rem] flex items-end justify-center">Si hay bienes a transferir</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
                  Inmuebles, cuentas bancarias, vehículos, acciones o cuotas societarias: inscribimos
                  todos los bienes a nombre de los herederos, con toda la documentación en regla.
                </p>
              </div>
              <div className="text-center flex flex-col h-full">
                <div className="w-14 h-14 bg-primary-light text-primary flex items-center justify-center mx-auto mb-5 rounded-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 text-balance md:min-h-[4rem] flex items-end justify-center">Si hay disputa entre herederos</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
                  Mediamos entre las partes, protegemos tus derechos y, si no hay acuerdo, planteamos
                  la partición judicial para que cada heredero reciba lo que le corresponde.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-text-secondary text-sm text-center max-w-xl mx-auto mb-10">
              Trabajamos con toda clase de sucesiones. Si tu caso no aparece en la lista, consultanos igual.
            </p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-2xl mx-auto px-6">
            ...
            <FAQItem
              ...
              answer="Depende del juzgado, de si hay testamento y de si los herederos están de acuerdo. Una sucesión sin conflictos y con documentación completa suele resolverse entre 6 y 12 meses. Los casos con oposiciones, bienes en varias jurisdicciones o herederos incapaces pueden llevar más tiempo."
            />
            <FAQItem
              question="¿Cuánto cuesta hacer una sucesión?"
              answer="Los costos incluyen tasa de justicia, aportes profesionales, publicación de edictos y honorarios, y se calculan sobre una escala arancelaria basada en el activo hereditario. En la primera consulta te damos un presupuesto claro antes de avanzar."
            />
            <FAQItem
              question="¿Puedo hacer la sucesión si no vivo en Mar del Plata?"
              answer="Sí. La mayoría de los trámites se gestionan de forma digital o mediante poder. Podemos representarte estés donde estés en el país o en el exterior, siempre que la sucesión corresponda tramitarse en la jurisdicción de Mar del Plata."
            />
            <FAQItem
              question="¿Qué pasa si un heredero se opone o no aparece?"
              answer="El trámite igual puede avanzar. A los herederos que no comparecen se los cita por edictos y el juzgado los tiene por notificados. Si hay oposiciones activas, buscamos primero un acuerdo entre las partes; si no hay acuerdo, se resuelve por vía judicial."
            />
          </div>
        </section>
        ...
        <section className="py-24 bg-primary">
          <div className="max-w-2xl mx-auto px-6 text-center">
            <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-4">
              Un momento difícil.
              <br />
              <span className="text-white/70">Un equipo que te acompaña.</span>
            </h2>
            <p className="text-white/50 text-base mb-10">
              Consultanos y nos encargamos del trámite completo, con seguimiento en cada etapa.
            </p>
