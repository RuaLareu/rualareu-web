...
import { Phone, MessageCircle, Star, Search, FileText, Rocket, ChevronDown } from "lucide-react";
...
export default function ConstitucionDeSociedadesLanding() {
  return (
    <>
      <script
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Elegimos juntos el tipo societario</h3>
              ...
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Nos ocupamos de todo el trámite</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
              ...
              <div className="text-center flex flex-col h-full">
                ...
                <h3 className="font-semibold text-primary text-lg mb-3 min-h-[3.5rem] flex items-end justify-center">Tu empresa arranca operativa</h3>
                <p className="text-text-secondary text-sm leading-relaxed flex-1">
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                "Monotributista que pasa a sociedad",
                "Sociedades para emprendimientos",
                "Holding familiar",
              ].map((item) => (
                <span
                  key={item}
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { step: "2", title: "Preparamos la documentación", desc: "Redactamos estatuto y actas, y te pedimos solo lo indispensable." },
        ...
        <section className="py-20 bg-background">
          <div className="max-w-2xl mx-auto px-6">
            ...
            <FAQItem
              ...
              answer="Sí, y muchas veces conviene: analizamos tu carga fiscal actual y te mostramos si el salto a sociedad te ahorra impuestos o te ordena la operación."
            />
            <FAQItem
